...
// Roles pour les utilisateurs clients dans les Organisations clients
public enum CustomerRole {
    /** Droit d'administration de l'organisation client. */
    ADMIN,
    /** Droit de souscription dans l'organisation client. */
    SOUSCRIPTEUR,
    /** Droits d'utilisateur. */
    USER,
    /** Remplacant pour le DI. */
    DELEGUE;
